...
. /home/l/lebreton/Documents/Legos/workflow/Github/aditional_function.sh
...
Rough_DEM_full=/data/icesat/produits/Global_DEM/GLO-30m-DTED/GLO-30_Glaciers.vrt  # link GLO-30 file
dir=/home/l/lebreton/Documents/Legos/workflow/Github/Bologna_WNA/ # Directory with PAN and MS folder images
COR=BM # Choose Block Matching (BM) or Semi Global Matching (SGM)
name=Bologna # Output prefix for DEM and orthos images
...
settings=/home/l/lebreton/Documents/Legos/workflow/Github/stereo.default_SGM
parallel_stereo --processes 7 --nodes-list $4 --threads-singleprocess 8 --parallel-options "--sshdelay 1 --controlmaster" -t rpcmaprpc -s $settings \
...
settings=/home/l/lebreton/Documents/Legos/workflow/Github/stereo.default.Int
